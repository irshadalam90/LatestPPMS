...
@Entity
@Table(name="product_mfg_details")
public class ProductMfgDetailsPojo implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 4771810725656469495L;
	@Id
	@GeneratedValue
	@Column(name="id")
	private Integer id;
