...
<body>
	...
	<div class="col-md-12">	
		<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
			<div class="col-md-4"><h3>Edit Gst Received</h3></div>
			<div class="col-md-7"></div>
			<div class="col-md-1"><a href="view-gst-received"><i class="fa fa-angle-left" style="font-size:20px;"></i> Back</a></div>
		</div>
		<!-- <div style="margin-top:10px;border-bottom:2px solid #23133a;padding-bottom:10px;"><h3>Edit Gst Received</h3></div> -->
		<div style="margin-top:20px;"><h4>Supplier Information</h4></div><hr>
 	 <form id="update-gst-received-form">
 	 <input type="hidden" id="gst-received-id" name="id" value="${rawReceivedObj.gstReceived.id}">
	<div class="col-md-6">
          <div class="form-group">
            <div class="col-md-4 inp-field">Supplier Name*</div>
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="supplierName" id="supplier_name" onchange="getSupplerAddress()">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><textarea rows="6" class="form-control" name="shippingAddress" placeholder="Enter Shipping Address">${rawReceivedObj.gstReceived.shippingAddress}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Shipped By</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="shipBy" value="${rawReceivedObj.gstReceived.shipBy}" placeholder="Enter shipped by"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Tracking Ref. No</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="trackNo" value="${rawReceivedObj.gstReceived.trackNo}" placeholder="Enter track reference number"></div>
          </div>
	...
	<div class="col-md-6">         
          ...
          <div class="form-group">
            ...
            <div class="input-group col-md-6 inp-field" >
       		...
       		<input type="text" required class="form-control" name="invoiceDate" value="${rawReceivedObj.gstReceived.invoiceDate}" id="datepicker" style="color:#27AAE1; font-weight: bold; font-family: Arial, Helvetica, sans-serif; font-size: 0.9em;">
      		</div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="paymentDays" id="payment-days" value="${rawReceivedObj.gstReceived.paymentDays}"></div>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="invoiceNo" value="${rawReceivedObj.gstReceived.invoiceNo}" placeholder="Enter invoice number"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Vehicle No.</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="vehicleNo" value="${rawReceivedObj.gstReceived.vehicleNo}" placeholder="Enter vehicle number"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Driver Name</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" value="${rawReceivedObj.gstReceived.driverName}" name="driverName" placeholder="Enter driver name"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Driver Mobile No.</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="driverNo" value="${rawReceivedObj.gstReceived.driverNo}" placeholder="Enter driver contact number"></div>
          </div>
          ...
          <div class="form-group col-md-3">
            ...
            <div class="inp-field">
            	<select class="form-control" id="product_name" onchange="getProductFields()">
         ...
         <div class="col-md-12"></div>
          ...
          <div class="form-group">
           ...
           <div class="col-md-6 inp-field"><input type="number" value="${rawReceivedObj.gstReceived.shippingCost}" onkeyup="shipChargeGstOnkeyup()" class="form-control ship-charge" name="shippingCost" placeholder="" value="0"></div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 inp-field"><textarea class="form-control" name="additionalNote1" placeholder="Write something ...">${rawReceivedObj.gstReceived.additionalNote1}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional Charges 1 (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" name="additonalChg1" class="form-control additional-charge1" value="${rawReceivedObj.gstReceived.additonalChg1}" onkeyup="additionalCharge1GstOnkeyup()" placeholder="" value=0></div>
           </div>
           <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 inp-field"><textarea class="form-control" name="additonalNote2" placeholder="Write something ...">${rawReceivedObj.gstReceived.additonalNote2}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional Charges 2 (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" class="form-control additional-charge2" name="additonalChg2" value="${rawReceivedObj.gstReceived.additonalChg2}" onkeyup="additionalCharge2GstOnkeyup()" value="0" placeholder=""></div>
           </div>
           <div class="form-group">
	...
	<div class="col-md-6">         
          ...
          <div class="col-md-12"><hr></div>
           ...
           <input type="hidden" >
        	<div class="col-md-12">
        		<div class="col-md-10"></div>
		<div class="col-md-2"><button class="btn" style="background-color:#23133a;color:#fff">Update Gst Received</button></div>
	</div> 
...
function getGstReceivedProducts(){
	...
	var gstReceivedId = $("#gst-received-id").val();
...
function calTotalCgst(){
	...
	$(document).ready(function(){
		...
		var updateGstReceivedForm = $("#update-gst-received-form");
		updateGstReceivedForm.submit(function(e){
			e.preventDefault(); 
	...
	console.log(gstReceivedForm);
	     $.ajax({
	     type: "POST",
	     url: "update-gst-received", 
