...
<body>
		...
		<div class="col-md-12">	
			<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
				<div class="col-md-6"><h3>Add Purchase Order (PO) Received</h3></div>
...
<!--              <div class="col-md-8 inp-field"><input type="text" required class="form-control" name="invoiceDate" id="datepicker" style="color:#27AAE1; font-weight: bold; font-family: Arial, Helvetica, sans-serif; font-size: 0.9em;"></div>
 -->                   
           </div>
           <div class="form-group">
            ...
            <div class="col-md-12">
			    ...
			    <!-- Nav tabs -->
			     <ul class="nav nav-tabs" role="tablist" id="myTab">
			        <li role="presentation" class="active"><a href="#comments" aria-controls="comments"  data-toggle="tab">Comments</a></li>
			        <li role="presentation"><a href="#private-comments" aria-controls="private-comments"  data-toggle="tab">Private Comments</a></li>
			        <li role="presentation"><a href="#note-comments" aria-controls="note-comments"  data-toggle="tab">Note Comments</a></li>
			    ...
			    <div class="tab-content">
			        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane active"  id="comments" contenteditable="true" placeholder="[Enter received order notes]"></div>
...
function addProductToTable(){
    ...
    if($("#savebutton").text() == "Update"){
    	...
    	$("#product_size").attr("disabled",false);
    	$("#cancel_btn").hide();
    	$("#savebutton").text("Add");
...
function calTotalCgst(){
	...
	function getSupplerAddress(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$("#sales-person").html(optionsSalePerson);
				optionsSalePerson +=  '<option>'+data[7]+'</option>';
				for(var i=0; i<salesPerson.length; i++){
					optionsSalePerson +=  '<option>'+salesPerson[i]+'</option>';
				}
	...
	function getSalesPerson(){
		...
		$.ajax({
			type: 'GET',
			url: 'get-sales-person',
			dataType: 'json', 
			success: function(data){
			 for(var i=0; i<data.length; i++){ 
				 salesPerson.push(data[i]);
			 }
			},
			error: function(){
				alert(arguments[2]);
