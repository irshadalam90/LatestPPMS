...
<title>View Detail Raw Received</title>
...
<body>
		<div class="col-md-12">	
			<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
				<div class="col-md-6"><h3>View Purchase Order (PO) Received</h3></div>
				<div class="col-md-5"></div>
				<div class="col-md-1"><a href="view-raw-received"><i class="fa fa-angle-left" style="font-size:20px;"></i> Back</a></div>
			</div>
			<!-- <div style="margin-top:10px;border-bottom:2px solid #23133a;padding-bottom:10px;"><h3>View Purchase Order (PO) Received</h3></div> -->
		...
		<div class="col-md-6">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><textarea rows="6" class="form-control" name="shippingAddress" placeholder="Enter Shipping Address" disabled>${rawReceivedObj.rawReceived.shippingAddress}</textarea></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Shipped By</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="shipBy" value="${rawReceivedObj.rawReceived.shipBy}" placeholder="Enter shipped by"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Tracking Ref. No</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="trackNo" value="${rawReceivedObj.rawReceived.trackNo}" placeholder="Enter track reference number"></div>
           </div>
		...
		<div class="col-md-6">         
           ...
           <div class="form-group">
             ...
             <div class="input-group col-md-6 inp-field" >
        		...
        		<input type="text" required class="form-control" name="invoiceDate" value="${rawReceivedObj.rawReceived.invoiceDate}" readonly id="datepicker" style="color:#27AAE1; font-weight: bold; font-family: Arial, Helvetica, sans-serif; font-size: 0.9em;">
       		</div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="paymentDays" id="payment-days" value="${rawReceivedObj.rawReceived.paymentDays}"></div>
           </div> 
           <div class="form-group">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="invoiceNo" value="${rawReceivedObj.rawReceived.invoiceNo}" placeholder="Enter invoice number"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Vehicle No.</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="vehicleNo" value="${rawReceivedObj.rawReceived.vehicleNo}" placeholder="Enter vehicle number"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Driver Name</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" value="${rawReceivedObj.rawReceived.driverName}" readonly name="driverName" placeholder="Enter driver name"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Driver Mobile No.</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="driverNo" value="${rawReceivedObj.rawReceived.driverNo}" placeholder="Enter driver contact number"></div>
           </div>
...
<%-- 						<tr class='dynamic' class='info'><td class='sNo'>${i.count}</td><td class='productName'>${rrp.productName}</td><td class='productSize'>${rrp.productSize}</td><td class='batchNo'>${rrp.batchNo}</td><td class='quantity'>${rrp.quantity}</td><td class='unit'>${rrp.unit}</td><td class='rate'>${rrp.rate}</td><td class='gstPer'>${rrp.gstPer}</td><td class='gstRate'>${rrp.gstRate}</td><td class='totalDiscount'>${rrp.totalDiscount}</td><td class='amount'>${rrp.amount}</td><td><span class='editrow'><a class='fa fa-edit' href='javascript: void(0);'></a></span></td><td><span class='deleterow'><a class='glyphicon glyphicon-trash' href='javascript: void(0);'></a></span></td></tr>"
 --%>					
           ...
           <div class="form-group">
            ...
            <div class="col-md-6 inp-field"><input type="number" readonly value="${rawReceivedObj.rawReceived.shippingCost}" onkeyup="shipChargeGstOnkeyup()" class="form-control ship-charge" name="shippingCost" placeholder="" value="0"></div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-md-6 inp-field"><textarea class="form-control" name="additionalNote1" placeholder="Write something ..." disabled>${rawReceivedObj.rawReceived.additionalNote1}</textarea></div>
           </div>
           <div class="form-group">
             <div class="col-md-6 inp-field">Additional Charges 1 (Rs)</div>
             <div class="col-md-6 inp-field"><input type="number" name="additonalChg1" class="form-control additional-charge1" readonly value="${rawReceivedObj.rawReceived.additonalChg1}" onkeyup="additionalCharge1GstOnkeyup()" placeholder="" value=0></div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
             ...
             <div class="col-md-6 inp-field"><textarea class="form-control" name="additonalNote2" placeholder="Write something ..." disabled>${rawReceivedObj.rawReceived.additonalNote2}</textarea></div>
           </div>
           <div class="form-group">
             <div class="col-md-6 inp-field">Additional Charges 2 (Rs)</div>
             <div class="col-md-6 inp-field"><input type="number" class="form-control additional-charge2" readonly name="additonalChg2" value="${rawReceivedObj.rawReceived.additonalChg2}" onkeyup="additionalCharge2GstOnkeyup()" value="0" placeholder=""></div>
           </div>
           <div class="form-group">
           ...
           <div class="col-md-12"><hr></div>
            <div class="col-md-12">
			    ...
			    <div class="tab-content">
			        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane active"  id="home" contenteditable="true" placeholder="[Enter invoice notes]" readonly>${rawReceivedObj.rawReceived.comments}</div>
