...
<title>Edit Supplier Group</title>
...
<body>
	<div class="col-md-12">
		...
		<div style="margin-top:20px;"><h4>Edit Supplier Group</h4></div><hr>
	...
	<input type="hidden" name="id" value="${supplierGroup.id}">
          <div class="form-group">
           <div class="col-md-3 inp-field">Supplier Group Name*</div>
            <div class="col-md-9 inp-field"><input type="text" class="form-control" name="supplierGroup" placeholder="Supplier Group Name" value="${supplierGroup.supplierGroup}"></div>
          </div>
          <div class="form-group">
            <div class="col-md-3 inp-field">Description</div>
            <div class="col-md-9  inp-field"><textarea class="form-control" rows="5" name="description" placeholder="Write Description">${supplierGroup.description}</textarea></div>
          </div>
