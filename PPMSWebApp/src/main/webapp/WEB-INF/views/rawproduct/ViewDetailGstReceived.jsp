...
<title>View Detail Gst Received</title>
...
<body>
	<div class="col-md-12">
		<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
			<div class="col-md-4"><h3>View Gst Received</h3></div>
			<div class="col-md-7"></div>
			<div class="col-md-1"><a href="view-gst-received"><i class="fa fa-angle-left" style="font-size:20px;"></i> Back</a></div>
		</div>
		<!-- <div style="margin-top:10px;border-bottom:2px solid #23133a;padding-bottom:10px;"><h3>View Gst Received</h3></div> -->
		
		<div style="margin-top:20px;"><h4>Supplier Information</h4></div><hr>
 	 <form id="raw-received-form">
 	 <input type="hidden" id="raw-received-id" value="${rawReceivedObj.gstReceived.id}">
	<div class="col-md-6">
          <div class="form-group">
            <div class="col-md-4 inp-field">Supplier Name*</div>
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="supplierName" id="supplier_name" onchange="getSupplerAddress()" disabled>
            		
            		<option>${rawReceivedObj.gstReceived.supplierName}</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><textarea rows="6" class="form-control" name="shippingAddress" placeholder="Enter Shipping Address" disabled>${rawReceivedObj.gstReceived.shippingAddress}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Shipped By</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="shipBy" value="${rawReceivedObj.gstReceived.shipBy}" placeholder="Enter shipped by"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Tracking Ref. No</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="trackNo" value="${rawReceivedObj.gstReceived.trackNo}" placeholder="Enter track reference number"></div>
          </div>
	...
	<div class="col-md-6">         
          ...
          <div class="form-group">
            ...
            <div class="input-group col-md-6 inp-field" >
       		...
       		<input type="text" required class="form-control" name="invoiceDate" value="${rawReceivedObj.gstReceived.invoiceDate}" readonly id="datepicker" style="color:#27AAE1; font-weight: bold; font-family: Arial, Helvetica, sans-serif; font-size: 0.9em;">
      		</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Payment Terms</div>
            <div class="col-md-8 inp-field"><select class="form-control" name="paymentTerm" disabled>
              <option>${rawReceivedObj.gstReceived.paymentTerm}</option>
            	<option>COD</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="paymentDays" id="payment-days" value="${rawReceivedObj.gstReceived.paymentDays}"></div>
          </div> 
          <div class="form-group">
            <div class="col-md-4 inp-field">Sales Person</div>
            <div class="col-md-6 inp-field">
            	<select class="form-control" name="salesPerson" id="sales-person" disabled>
            		<option selected>${rawReceivedObj.gstReceived.salesPerson}</option>
            ...
            <div class="col-md-2 inp-field"><a href="add-references" class="btn btn-default" disabled style="font-size:18px;"><i class="fa fa-plus"></i></a></div>
           </div>
          <%-- <div class="form-group">
            <div class="col-md-4 inp-field">Sales Person*</div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="invoiceNo" value="${rawReceivedObj.gstReceived.invoiceNo}" placeholder="Enter invoice number"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Vehicle No.</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="vehicleNo" value="${rawReceivedObj.gstReceived.vehicleNo}" placeholder="Enter vehicle number"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Driver Name</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" value="${rawReceivedObj.gstReceived.driverName}" readonly name="driverName" placeholder="Enter driver name"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Driver Mobile No.</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="driverNo" value="${rawReceivedObj.gstReceived.driverNo}" placeholder="Enter driver contact number"></div>
          </div>
          ...
          <div class="form-group col-md-3">
            ...
            <div class="inp-field">
            	<select class="form-control" name="productName" id="product_name" onchange="getProductFields()" disabled>
          ...
          <div class="form-group col-md-3">
            ...
            <div class="inp-field">
            	<select class="form-control" name="productSize" id="product_size" disabled>
          ...
          <div class="form-group col-md-3">
            <div>Batch No.</div>
            <div class="inp-field"><input type="text" class="form-control batchNO"  id="batch_no" placeholder="Enter batch number" readonly></div>
          </div>
          <div class="form-group col-md-3">
            <div>Unit</div>
            <div class="inp-field"><input type="text" class="form-control" id="measurement_unit"  placeholder="" readonly></div>
          </div>
          <div class="form-group col-md-3">
            <div>Qty*</div>
            <div class="inp-field"><input type="number" value=0 class="form-control qty" id="quantity" placeholder="" onkeyup="calTotal()" readonly></div>
          </div>
          <div class="form-group col-md-3">
            <div>Rate*</div>
            <div class="inp-field"><input type="number" value=0 class="form-control rate"  id="prate" placeholder="" onkeyup="return calTotal()" readonly></div>
          </div>
          <div class="form-group col-md-3">
            <div><input type="radio" checked name="tax" value="gstper"> GST <input type="radio" name="tax" id="tax" value="igstper" readonly> IGST(%)*</div>
            <div class="inp-field">
            	<select class="form-control gst" id="gstper"  onchange="return getGstRate();" disabled>
          ...
          <div class="form-group col-md-3">
            ...
            <div class="inp-field"><input type="number"  class="form-control gstRate" id="gst-rate" name="gstRate" placeholder="" value=0 onkeyup="getRate()" readonly></div>
          </div>
          <div class="col-md-12"></div>
          <div class="form-group col-md-2">
            <div>Discount 1 (Note)</div>
            <div class="inp-field"><input type="text" class="form-control" placeholder="Discount 1 Desc." id="disc_desc1" readonly></div>
          </div>
          <div class="form-group col-md-2">
            <div>Discount 1(%)</div>
            <div class="inp-field"><input type="number" value=0 class="form-control disc-per1" readonly id="disc_per1" onkeyup="return discountRs1();" placeholder="%"></div>
          </div>
          <div class="form-group col-md-2">
            <div>Discount 1(Rs)</div>
            <div class="inp-field"><input type="number" value=0 class="form-control disc-rs1" readonly id="discount1" onkeyup="discountPer1()" placeholder="Rs."></div>
          </div>
          <div class="form-group col-md-2">
            <div>Discount 2 (Note)</div>
            <div class="inp-field"><input type="text" class="form-control" readonly placeholder="Discount 2 Desc." id="disc_desc2"></div>
          </div>
          <div class="form-group col-md-2">
            <div>Discount 2(%)</div>
            <div class="inp-field"><input type="number" value=0 class="form-control disc-per2" readonly onkeyup="return discountRs2();" id="disc_per2" placeholder="%"></div>
          </div>
          <div class="form-group col-md-2">
            <div>Discount 2(Rs)</div>
            <div class="inp-field"><input type="number" value=0 class="form-control disc-rs2" readonly id="discount2" onkeyup="discountPer2()" id="" placeholder="Rs."></div>
          </div>
          ...
          <div class="col-md-2"><a href="javascript:void(0);" class="btn btn-success" disabled onclick="return addProductToTable();" id="savebutton">Add</a></div>
         <div class="col-md-12"></div>
...
<%-- 						<tr class='dynamic' class='info'><td class='sNo'>${i.count}</td><td class='productName'>${rrp.productName}</td><td class='productSize'>${rrp.productSize}</td><td class='batchNo'>${rrp.batchNo}</td><td class='quantity'>${rrp.quantity}</td><td class='unit'>${rrp.unit}</td><td class='rate'>${rrp.rate}</td><td class='gstPer'>${rrp.gstPer}</td><td class='gstRate'>${rrp.gstRate}</td><td class='totalDiscount'>${rrp.totalDiscount}</td><td class='amount'>${rrp.amount}</td><td><span class='editrow'><a class='fa fa-edit' href='javascript: void(0);'></a></span></td><td><span class='deleterow'><a class='glyphicon glyphicon-trash' href='javascript: void(0);'></a></span></td></tr>"
 --%>					
          ...
          <div class="form-group">
           ...
           <div class="col-md-6 inp-field"><input type="number" readonly value="${rawReceivedObj.gstReceived.shippingCost}" onkeyup="shipChargeGstOnkeyup()" class="form-control ship-charge" name="shippingCost" placeholder="" value="0"></div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-md-6 inp-field">
             	<select class="form-control ship-gst" name=shippingGstPer id="" onchange="shipChargeGstOnchange()" disabled>
             		<option>${rawReceivedObj.gstReceived.shippingGstPer}</option>
            		<option>0</option>
            		<option>5</option>
            		<option>12</option>
            		<option>18</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 inp-field"><textarea class="form-control" name="additionalNote1" placeholder="Write something ..." disabled>${rawReceivedObj.gstReceived.additionalNote1}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional Charges 1 (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" name="additonalChg1" class="form-control additional-charge1" readonly value="${rawReceivedObj.gstReceived.additonalChg1}" onkeyup="additionalCharge1GstOnkeyup()" placeholder="" value=0></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional GST*</div>
            <div class="col-md-6 inp-field">
            	<select class="form-control additional-gst1" name="additonalChg1Per" id="" onchange="additionalCharge1GstOnchange()" disabled>
            		<option>${rawReceivedObj.gstReceived.additonalChg1Per}</option>
            		<option>0</option>
            		<option>5</option>
            		<option>12</option>
            		<option>18</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 inp-field"><textarea class="form-control" name="additonalNote2" placeholder="Write something ..." disabled>${rawReceivedObj.gstReceived.additonalNote2}</textarea></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional Charges 2 (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" class="form-control additional-charge2" readonly name="additonalChg2" value="${rawReceivedObj.gstReceived.additonalChg2}" onkeyup="additionalCharge2GstOnkeyup()" value="0" placeholder=""></div>
           </div>
           <div class="form-group">
             <div class="col-md-6 inp-field">GST On Additional Charges 2 (%)
</div>
             <div class="col-md-6 inp-field">
             	<select class="form-control additional-gst2" name="additonalChg2Per"  id="" onchange="additionalCharge2GstOnchange()" disabled>
             		<option>${rawReceivedObj.gstReceived.additonalChg2Per}</option>
            		<option>0</option>
            		<option>5</option>
            		<option>12</option>
            		<option>18</option>
	...
	<div class="col-md-6">         
          ...
          <div class="form-group">
           ...
           <div class="col-md-6 inp-field"><input type="number" readonly id="sub-total" class="form-control subTotal" name="subtotal" value="${rawReceivedObj.gstReceived.subtotal}" placeholder="" value="0" style="background-color:yellow"></div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-6 inp-field">Shipping Charges (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" name="shippingGstAmt" readonly class="form-control shipping-charge" value="${rawReceivedObj.gstReceived.shippingGstAmt}"  placeholder="" value="0" style="background-color:yellow"></div>
          </div>	
          <div class="form-group">
            <div class="col-md-6 inp-field">Additional Charges (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" readonly class="form-control total-additional-charge" name="totalAdditionChg" value="${rawReceivedObj.gstReceived.totalAdditionChg}" placeholder="" value="0" style="background-color:yellow"></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">SGST (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" name="totalSGSTAmt" value="${rawReceivedObj.gstReceived.totalSGSTAmt}" readonly class="form-control total-sgst" id="" placeholder="" value="0" style="background-color:yellow"></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">CGST (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" name="totalCGSTAmt" value="${rawReceivedObj.gstReceived.totalCGSTAmt}" readonly class="form-control total-cgst" id="" placeholder="" value="0" style="background-color:yellow"></div>
          </div>
          <div class="form-group">
            <div class="col-md-6 inp-field">Grand Total (Rs)</div>
            <div class="col-md-6 inp-field"><input type="number" readonly class="form-control" id="grand-total" name="grandTotal" value="${rawReceivedObj.gstReceived.grandTotal}" placeholder="" value="0" style="background-color:yellow"></div>
          </div>
        </div>
          ...
          <div class="col-md-12"><hr></div>
           <div class="col-md-12">
		    ...
		    <div class="tab-content">
		        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane active"  id="home" contenteditable="true" placeholder="[Enter invoice notes]" readonly>${rawReceivedObj.gstReceived.comments}</div>
		        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane" id="profile" contenteditable="true" placeholder="[Enter internal notes]">${rawReceivedObj.gstReceived.privateComments}</div>
		        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane" id="messages" contenteditable="true" placeholder="[Please contact us for more information about payment options.]">${rawReceivedObj.gstReceived.noteComments}</div>
		        <div role="tabpanel" style="height:200px;width:600px;border:1px solid black;padding:10px;" class="tab-pane" id="settings" contenteditable="true" placeholder="[Thank you for your business.]">${rawReceivedObj.gstReceived.footerComments}</div>
		    </div> 
...
$(document).ready(function(){
	  ...
	  getGstReceivedProducts();
	  
});

function getGstReceivedProducts(){
	
	var gstReceivedId = $("#raw-received-id").val();

	$.ajax({
		type: 'GET',
		url: 'get-gst-received-products?id='+gstReceivedId+'',
		dataType: 'json', 
...
function calTotalCgst(){
	...
	$("tbody tr.dynamic").each(function(){
	    ...
	    var rate=td.eq(5).text();
	    var gstPer=td.eq(6).text();
	    var gstRate=td.eq(7).text();
	    var totalDiscount=td.eq(8).text(); 
	    var amount=td.eq(9).text();
	    var discountRat1=td.eq(10).text();
	...
	function editRawReceivedProduct(id){
		$.ajax({
		     type: "POST",
		     url: "edit-raw-received-product/"+id+"", 
		     dataType: 'json',
		     success: function(data){
		         //alert(data);
		         var optionProductName;
		         var optionProductSize;
		         optionProductName = '<option>'+data.productName+'</option>'
		       	 $("#product_name").html(optionProductName);
		         optionProductSize = '<option>'+data.productSize+'</option>'
		       	 $("#product_size").html(optionProductSize);
		         $("batch-no").val(data.BatchNo);
		         $("#quantity").val(data.quantity);
		         //$("#quantity").val(data.measurmentUnit);
		         $("#prate").val(data.rate);
		         $("#gstper").val(data.gstPer);
		         $("#gst-rate").val(data.gstRate);
	...
	function updateProduct(){
         ...
         var discountPer1=$("#disc_per1").val();
         var discountRate1=$("#discount1").val();
         var discountPer2=$("#disc_per2").val();
         var discountRate2=$("#discount2").val();
         var rate=$("#prate").val();
         var gstPer=$("#gstper").val();
         var gstRate=$("#gst-rate").val();
        ...
        // alert(jsonProduct);
         var rawReceivedId = $('#raw-receivedid').val();
         //alert(rawReceivedId)
         $.ajax({
		     type: "POST",
		     url: "update-raw-received-product", 
		     //dataType: 'json',
		     data: {jsonProduct: jsonProduct/* , rawReceivedId: rawReceivedId */},
		     success: function(data){
		         alert(data);
