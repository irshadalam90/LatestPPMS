...
<title>View Detail Product Manufacture</title>
...
<body>
		...
		<div class="col-md-12">
			<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
				<div class="col-md-5"><h3>View Detail Product Manufacture</h3></div>
		...
		<div class="col-md-6">
           <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="date" readonly class="form-control ship-charge" name="productMfgdate" value="${productMfgData.productMfgdate}"></div>
           </div>
          
           <div class="form-group">
             <div class="col-md-4 inp-field">Start Time*</div>
             <div class="col-md-8 inp-field"><input type="time" readonly class="form-control" name="startTime" value="${productMfgData.startTime}"></div>
           </div>
           
           <div class="form-group">
             <div class="col-md-4 inp-field">End Time*</div>
             <div class="col-md-8 inp-field"><input type="time" readonly class="form-control" name="endTime" value="${productMfgData.endTime}"></div>
           </div>
		...
		<div class="col-md-12"><hr></div>	
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="sheetName" readonly id="sheet-name" onchange="getSheetMfgSize();">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="sheetSize" readonly id="sheet-size" onchange="getSheetMfgGage();">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="sheetGage" readonly id="sheet-gage" onchange="getSheetMfgAvlQty();">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" id="available-qty" readonly name="availableQty" placeholder="" value="${productMfgData.availableQty}"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Used Qty*</div>
             <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" name="usedQty" placeholder="Used Quantity" value="${productMfgData.usedQty}"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Batch No</div>
             <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" name="batchNo" placeholder="Batch No." value="${productMfgData.batchNo}"></div>
           </div>
           </div>
		...
		<div class="col-md-6">         
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="productName" readonly id="product-name" onchange="getMfgProductSize()">
           ...
           <div class="form-group">
			...
			<div class="col-md-8 inp-field">
             	<select class="form-control" name="productSize" readonly id="product-size" onchange="getMfgProductGage()">
           ...
           <div class="form-group">
			 ...
			 <div class="col-md-8 inp-field">
             	<select class="form-control" name="productGage" readonly id="product-gage">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" name="mfgQtyPiece" placeholder="Pices" value="${productMfgData.mfgQtyPiece}"></div>
           </div>
		   <div class="form-group">
             <div class="col-md-4 inp-field">Manufacture Unit*</div>
             <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" name="mfgQtyKg" placeholder="Kg" value="${productMfgData.mfgQtyKg}"></div>
           </div>
		</div>
		<!-- <div class="col-md-12"><hr></div>
         	<div class="col-md-12">
	     ...
	     data: productMfgForm.serialize(),
	   	 success: function(response){
	   		 if(response == "success"){
				 ...
				 window.location = "add-product-mfg";	
	   		 }
	     },
	     error: function(){
	         alert("Successfully submitted !!");
