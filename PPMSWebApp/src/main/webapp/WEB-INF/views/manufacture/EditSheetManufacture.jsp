...
<body>
		...
		<div class="col-xs-12">
			<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
				<div class="col-md-5"><h3>Edit Sheet Manufacture</h3></div>
		...
		<div class="col-md-6">
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="productName" id="product-name" >
		...
		<div class="col-md-6">         
         ...
         <div class="col-md-12" style="margin-top:10px;border-top:2px solid #23133a;padding-bottom:10px;"></div>
           ...
           <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="date" class="form-control ship-charge" name="sheetMfgdate" value="${sheetMfgData.sheetMfgdate}"></div>
           </div>
          
           <div class="form-group">
             <div class="col-md-4 inp-field">Start Time*</div>
             <div class="col-md-8 inp-field"><input type="time" class="form-control" name="startTime" value="${sheetMfgData.endTime}"></div>
           </div>
           
           <div class="form-group">
             <div class="col-md-4 inp-field">End Time*</div>
             <div class="col-md-8 inp-field"><input type="time" class="form-control" name="endTime" value="${sheetMfgData.endTime}"></div>
           </div>
           </div>
		...
		<div class="col-md-6">         
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="sheetName" placeholder="Sheet Name" value="${sheetMfgData.sheetName}"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Sheet Size*</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="sheetSize" placeholder="Sheet Size" value="${sheetMfgData.sheetSize}"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Sheet Gage*</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="sheetGage" placeholder="Sheet Gage" value="${sheetMfgData.sheetGage}"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Manufacture Qty*</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="mfgQty" placeholder="Manufacture Quantity" value="${sheetMfgData.mfgQty}"></div>
           </div>
		</div>
		<div class="col-md-12"><hr></div>
         	<div class="col-md-12">
         	<div class="col-md-9"></div>
			<div class="col-md-3"><button class="btn" style="background-color:#23133a;color:#fff">Update Sheet Manufacture</button></div>
