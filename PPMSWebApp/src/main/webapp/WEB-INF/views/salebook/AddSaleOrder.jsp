	...
	<div class="row">
		...
		<div class="row">
			...
			<div style="margin-top:10px;border-bottom:2px solid #23133a;padding-bottom:10px;"><h3>Sale Order</h3></div>
				...
				<div style="margin-top:20px;"><h4>Add Sale Order</h4></div><hr>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8 inp-field"><input type="date" class="form-control" name="invoiceDate"></div>
            </div>
            <div class="form-group">
		...
		<div class="col-md-6">         
          ...
          <!--  <div class="col-md-12"><hr></div> -->
			...
			<div class="col-md-2"><button class="btn" style="background-color:#23133a;color:#fff">Add Sale Order</button></div>
		</div>
...
function calTotalCgst(){
	...
	$(document).ready(function(){
		var submitSaleOrderForm = $("#sale-order-form");
		submitSaleOrderForm.submit(function(e){
			e.preventDefault(); 
	...
	var saleOrderForm = JSON.stringify($('form').serializeObject());
	console.log(productData);
	console.log(saleOrderForm);
	     $.ajax({
	     type: "POST",
	     url: "submit-sale-order", 
	     data:{
	     ...
	     success: function(response){
	    	 if(response=="success"){
	        	...
	        	window.location = "add-sale-order";
	    	 }
	    	 else{
	    		 alert("failed");
	    	 }
