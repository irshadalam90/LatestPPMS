	...
	<div class="row">
		<div class="col-md-11 " style="margin-left:30px;">
			...
			<div style="margin-top:20px;">
				<div class="row">
				<div class="col-md-3"><h4>Gst Invoice</h4></div>
				<div class="col-md-7"></div>
				<div class="col-md-2"><a href="add-gst-invoice"><span class="fa fa-plus"></span> Add Gst Invoice</a></div>
				</div>
			<hr>
			...
			<div style="margin-top:20px;">
				<table class="table table-striped" id="example">
					...
					<tbody>
				 <c:forEach items="${gstInvoice}" var="invoice" varStatus="i"> 
					<tr>
						<td>${i.count}</td>
