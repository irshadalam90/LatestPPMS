...
<body>
	<div class="col-md-12">
		...
		<div style="margin-top:20px;"><h4>Product Packaging details</h4></div><hr>
	...
	<div class="col-md-6">
	   <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="date" class="form-control" name="packagingDate" required></div>
          </div>
          <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" readonly class="form-control" name="batchNo" id="productmfg-batchno"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Manufacture Qty</div>
            <div class="col-md-4 inp-field"><input type="text" readonly class="form-control" name="availablePacketweight" id="productmfg-qty"></div>
	...
	<div class="col-md-12"><hr></div>	
	  <input type="hidden" id="raw-product-id" name="rawProductId">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field">
            	<select id="plasticbag-prod-size" class="form-control" name="bagSize" onchange="getPlasticBagProdAvlQty();" required>
            		<option disabled selected>Select Bag Size</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field"><input type="text" class="form-control" id="qty-per-pkt" name="qtyPerPacket" placeholder="Enter qty per packet" onkeyup="calPktWeight();" required></div>
          	 <div class="col-md-3 inp-field">Pices</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Bag Weight*</div>
            <div class="col-md-5 inp-field"><input type="text" class="form-control" id="bagwt" name="bagweight" placeholder="Enter bag weight" onkeyup="calPktWtWithBag()" required></div>
        	<div class="col-md-3 inp-field">gm</div>
		 </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">No. of Packet*</div>
            <div class="col-md-5 inp-field"><input type="text" id="no-ofpkts" class="form-control" name="noOfPacketsCreated" placeholder="Enter number of packets" onkeyup="calTotalPackaging();" required></div>
          	 <div class="col-md-3 inp-field">Pices</div>
          </div>
          </div>
          
	<div class="col-md-6">         
       	<input type="hidden" id="productmfg-pktwth" name="singlePktWtKg">
         <div class="col-md-12"></div>
          <div class="form-group" style="margin-top:50px;">
            <div class="col-md-4 inp-field">Available Bag</div>
            <div class="col-md-5 inp-field"><input type="text" class="form-control" readonly name="availableBagQty" placeholder="" id="plasticbag-prod-avlqty"></div>
            <div class="col-md-3 inp-field">Kg</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Packet Weight</div>
            <div class="col-md-5 inp-field"><input type="text" id="total-pktwt" readonly class="form-control" name="packetWeight" placeholder=""></div>
          	 <div class="col-md-3 inp-field">gm</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Wt. with Bag</div>
            <div class="col-md-5 inp-field"><input type="text" class="form-control" readonly id="total-pktwt-withbag" name="weightWithBag" placeholder=""></div>
         	 <div class="col-md-3 inp-field">gm</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Total Packaging*</div>
            <div class="col-md-5 inp-field"><input type="text" id="total-packaging" readonly class="form-control" name="totalPacketing" placeholder=""></div>
            <div class="col-md-3 inp-field">kg</div>
          </div>
	</div>
	<div class="col-md-12"><hr></div>
