...
<title>View Detail Boxing</title>
...
<body>
	...
	<div class="col-md-6">
		 ...
		 <div class="col-md-8 inp-field">
            	<select class="form-control" id="plasticbag-name" readonly onchange="getPlasticBagSize();">
            		<option></option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" id="plasticbag-size" readonly onchange="getMfgProductName();">
            		<option></option>
            	</select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="" id="productmfg-name" readonly onchange="getProductSize();">
            		<option></option>
            	</select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field">
            	<select class="form-control" id="productmfg-size" readonly onchange="getProductGage();">
            		<option></option>      
            	</select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" id="productmfg-gage" readonly onchange="getPackettingQty();">
            		<option></option>
            	</select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field"><input type="text" readonly class="form-control" id="noofPkt-per-box" onkeyup="calBoxWeight()"></div>
       ...
       <div class="col-md-10"></div>
          <div class="col-md-2"><a href="javascript:void(0);" class="btn btn-success" onclick="return updateProduct();" id="savebutton">Add Into List</a></div>
          ...
          <div class="col-md-12" id="display-product" style="margin-top:20px;">
			...
			<tr>
				...
				<tbody>	
					...
					<tr class='dynamic' class='info'><td style='display:none'class='sNo'>"+ i +"</td><td style='display:none'class='rawProductId'>"+ productList[i].productId +"</td><td class='plasticBag'>${boxingProduct.plasticBag}</td><td class='bagSize'>${boxingProduct.bagSize}</td><td class='productName'>${boxingProduct.productName}</td><td class='productSize'>${boxingProduct.productSize}</td><td class='productGage'>${boxingProduct.productGage}</td><td class='qtyPerPkt'>${boxingProduct.qtyPerPkt}</td><td class='noOfPkts'>${boxingProduct.noOfPkts}</td><td class='boxWeight'>${boxingProduct.boxWeight}</td><td style='display:none'class='avlPkgWeight'>"+ productList[i].avlPkgWeight +"</td><td><span class='editrow'><a class='fa fa-edit' href='javascript: void(0);' onclick='editProduct("+i+",this)'></a></span></td><td><span class='deleterow'><a class='glyphicon glyphicon-trash' href='javascript: void(0);' onclick='deleteProduct("+i+",this)'></a></span></td></tr>
					</c:forEach>
				</tbody>
		</table>
          </div>   
	...
	<div class="col-md-12"><hr></div>	
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="boxName" readonly id="box-name" onchange='getBoxSize();'>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="boxSize" id="box-size" readonly onchange="getBoxAvlQty();">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" class="form-control" readonly name="createdBoxQty" id="total-box" placeholder="Total Box" onkeyup="calTotalWeight();" value="${boxingData.createdBoxQty}"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Total Weight*</div>
