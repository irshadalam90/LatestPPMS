...
<body>
	...
	<div class="col-md-12">
		<div class="row" style="border-bottom:2px solid #23133a;padding-bottom:10px;">
			<div class="col-md-5"><h3>Edit Product Packaging</h3></div>
			<div class="col-md-6"></div>
			<div class="col-md-1"><a href="view-packaging-details"><i class="fa fa-angle-left" style="font-size:20px;"></i> Back</a></div>
		</div>
	
		<div style="margin-top:20px;"><h4>Edit Product Packaging </h4></div><hr>
 	 <form id="product-packaging-form">
 	 <input type="hidden" id="productmfg-id" name="productMfgId" value="${packaging.productMfgId}">
	   ...
	   <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="productName" id="productmfg-name" onchange="getProductSize();" readonly>
         ...
         <div class="form-group">
            ...
            <div class="col-md-5 inp-field">
            	<select class="form-control" id="productmfg-size" name="productSize" placeholder="Product Size" onchange="getProductGage();" readonly>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" id="productmfg-gage" name="productGage" placeholder="Product Gage" onchange="getProductMfgQty()" readonly>
	...
	<div class="col-md-12"><hr></div>	
	  <input type="hidden" id="raw-product-id" name="rawProductId" value="${packaging.rawProductId}">
	  <input type="hidden" name="id" value="${packaging.id}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	...
            	<option>${packaging.plasticBag}</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field">
            	<select id="plasticbag-prod-size" class="form-control" name="bagSize"  onchange="getPlasticBagProdAvlQty();" required>
            		<option>${packaging.bagSize}</option>
	...
	<div class="col-md-6">         
       	<input type="hidden" id="productmfg-pktwth" name="singlePktWtKg" value="${packaging.singlePktWtKg}">
	...
	<div class="col-md-12"><hr></div>
		...
		<div class="col-md-3"><button class="btn" style="background-color:#23133a;color:#fff">Update Packaging Details</button></div>
          </div>
           </form> 
         </div>
...
$(document).ready(function(){
	...
	productPackagingForm.submit(function(e){
     ...
     $.ajax({
     type: "POST",
     url: "update-packaging-details", 
     data: productPackagingForm.serialize(),
   	 success: function(response){
   		 if(response == "success"){
	         alert("Successfully Updated !!");
			 window.location = "view-packaging-details";	
   		 }
     },
     error: function(){
