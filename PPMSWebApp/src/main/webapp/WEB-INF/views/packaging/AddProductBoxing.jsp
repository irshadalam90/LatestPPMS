...
<body>
	...
	<div class="col-md-12">
		...
		<div style="margin-top:20px;"><h4>Product Boxing details</h4></div><hr>
 	 <form id="boxing-form">
	<div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="date" class="form-control" name="boxingDate" required></div>
          </div>
          <input type="hidden" id="plasticbag-id">
         <div class="form-group">
            <div class="col-md-4 inp-field">Plastic Bag*</div>
		 <div class="col-md-8 inp-field">
            	<select class="form-control" id="plasticbag-name" name="plasticBag" onchange="getPlasticBagSize();">
            		<option disabled selected>Select Plastic Bag</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" id="plasticbag-size" name="bagSize" onchange="getMfgProductName();">
            		<option disabled selected>Select Plastic Bag Size</option>
            	</select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="productName" id="productmfg-name" onchange="getProductSize();">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5 inp-field">
            	<select class="form-control" id="productmfg-size" name="productSize" onchange="getProductGage();">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" id="productmfg-gage" name="productGage" onchange="getPackettingQty();">
            		<option disabled selected>Select Product Gage</option>
            	</select>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Qty Per Packets*</div>
            <div class="col-md-5 inp-field"><input type="text" class="form-control" name="qtyPerPkt" id="qty-per-pkt"></div>
          	 <div class="col-md-3 inp-field">Pieces</div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">No. Of Packets*</div>
            <div class="col-md-5 inp-field"><input type="text" class="form-control" name="noOfPkts" id="noofPkt-per-box" onkeyup="calBoxWeight()"></div>
          	 <div class="col-md-3 inp-field">Per Box</div>
          </div>
          
          <div class="form-group">
            <div class="col-md-4 inp-field">Total Weight*</div>
            <div class="col-md-5 inp-field"><input type="text" readonly class="form-control" name="boxWeight" id="box-weight"></div>
          	 <div class="col-md-3 inp-field">Kg/Box</div>
          </div>
          </div>
          
          <input type="hidden" id="productmfg-id">  
          <input type="hidden" id="sigle-pkt-wt" name="singlePktWt">
          <input type="hidden" id="total-pkg-wt">
       	
       <!-- <div class="col-md-10"></div>
          <div class="col-md-2"><a href="javascript:void(0);" class="btn btn-success" onclick="return addProductToTable();" id="savebutton">Add Into List</a></div>
	...
	<div class="col-md-12"><hr></div>	
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field">
            	<select class="form-control" name="boxName"  id="box-name" onchange='getBoxSize();'>
            		<option disabled selected>Select Box Name</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 inp-field"><input type="text" id="box-avl-qty" readonly class="form-control" name="availableBoxQty" placeholder=""></div>
          </div>
          <div class="col-md-12 inp-field"></div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Total Box*</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="createdBoxQty" id="total-box" placeholder="Total Box" onkeyup="calTotalWeight();"></div>
          </div>
          <div class="form-group">
            <div class="col-md-4 inp-field">Total Weight*</div>
            <div class="col-md-8 inp-field"><input type="text" class="form-control" name="totalWeight" id="total-weight" placeholder="Total Weight"></div>
	...
	<div class="col-md-12"><hr></div>
		...
		<div class="col-md-3"><button class="btn" style="background-color:#23133a;color:#fff">Add Boxing Details</button></div>
          </div>
           </form> 
         </div>
		...
		var new_row = "<tr class='dynamic' class='info'><td style='display:none' class='sNo'>"+ i +"</td><td style='display:none' class=''>"+ productId +"</td><td class='plasticBag'>" + plasticBag + "</td><td class='bagSize'>" + bagSize + "</td><td class='productName'>" + productName + "</td><td class='productSize'>" + productSize + "</td><td class='productGage'>" + productGage + "</td><td class='qtyPerPkt'>" + qtyPerPkt + "</td><td class='noOfPkts'>" + noOfPkts + "</td><td class='boxWeight'>" + boxWeight + "</td><td style='display:none' class='avlPkgWeight'>"+ avlPkgWeight +"</td><td style='display:none' class='singlePktWt'>"+ singlePktWt +"</td><td><span class='editrow'><a class='fa fa-edit' href='javascript: void(0);' onclick='editProduct("+i+",this)'></a></span></td><td><span class='deleterow'><a class='glyphicon glyphicon-trash' href='javascript: void(0);' onclick='deleteProduct("+i+",this)'></a></span></td></tr>";
 		...
 		var new_row="";
 	     for(i=0; i<productList.length; i++){
 	   	...
 	   	new_row += "<tr class='dynamic' class='info'><td style='display:none'class='sNo'>"+ i +"</td><td style='display:none'class=''>"+ productList[i].productId +"</td><td class='plasticBag'>" + productList[i].plasticBag + "</td><td class='bagSize'>" + productList[i].bagSize + "</td><td class='productName'>" + productList[i].productName + "</td><td class='productSize'>" + productList[i].productSize + "</td><td class='productGage'>" + productList[i].productGage + "</td><td class='qtyPerPkt'>" + productList[i].qtyPerPkt + "</td><td class='noOfPkts'>" + productList[i].noOfPkts + "</td><td class='boxWeight'>" + productList[i].boxWeight + "</td><td style='display:none' class='avlPkgWeight'>"+ productList[i].avlPkgWeight +"</td><td class='singlePktWt' style='display:none'>"+ productList[i].singlePktWt +"</td><td><span class='editrow'><a class='fa fa-edit' href='javascript: void(0);' onclick='editProduct("+i+",this)'></a></span></td><td><span class='deleterow'><a class='glyphicon glyphicon-trash' href='javascript: void(0);' onclick='deleteProduct("+i+",this)'></a></span></td></tr>";
...
function editProduct(index,cr){
	...
	$("#plasticbag-name").val($(cr).closest('tr').find('td.plasticBag').text());
	$("#plasticbag-size").val($(cr).closest('tr').find('td.bagSize').text());
	$("#productmfg-name").val($(cr).closest('tr').find('td.productName').text());
	$("#productmfg-size").val($(cr).closest('tr').find('td.productSize').text());
	$("#productmfg-gage").val($(cr).closest('tr').find('td.productGage').text());
...
// console.log(boxingData);
     $.ajax({
     type: "POST",
     url: "submit-bxing-details", 
     data: boxingForm.serialize(),
      /* data:{
...
var totalBox = parseFloat($('#total-box').val());
	...
	var singleBoxWt = parseFloat($('#box-weight').val());
