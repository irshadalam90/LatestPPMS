...
<body>
	...
	<div class="row">
		...
		<div style="margin-top:20px;"><h4>Edit Bank Entry</h4></div><hr>
		...
		<div class="col-md-6">         
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field"><input type="date" required class="form-control" value="${bankEntry.date}" name="date"></div>
           </div>
            ...
            <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="bankName" >
             		<option>${bankEntry.bankName}</option>
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="transactionType" >
             		<option>${bankEntry.transactionType}</option>
             		<option>Debit</option>
           ...
           <div class="form-group">
             ...
             <div class="col-md-8 inp-field">
             	<select class="form-control" name="particulars" >
             		<option>${bankEntry.particulars}</option>
         ...
         <div class="col-md-6"></div>
           ...
           <div class="form-group">
             ...
             <div class="col-md-7 inp-field"><input type="text" class="form-control" name="checkOrddno" value="${bankEntry.checkOrddno}" id="checkordd-no"></div>
           </div> 
           <div class="form-group">
             <div class="col-md-5 inp-field">Digital Mode Type</div>
             <div class="col-md-7 inp-field"><input type="text" class="form-control" name="digitalModeType" value="${bankEntry.digitalModeType}" id="digital-mode-type"></div>
           </div> 
           <div class="form-group">
             <div class="col-md-5 inp-field">Transaction No.</div>
             <div class="col-md-7 inp-field"><input type="text" class="form-control" name="transactionNo" value="${bankEntry.transactionNo}" id="transaction-no"></div>
           </div> 
           <div class="form-group">
             <div class="col-md-5 inp-field">Amount</div>
             <div class="col-md-7 inp-field"><input type="text" class="form-control" name="amount" value="${bankEntry.amount}"></div>
           </div> 
           <div class="form-group">
             <div class="col-md-5 inp-field">Note if any</div>
             <div class="col-md-7 inp-field"><input type="text" class="form-control" name="notes" value="${bankEntry.notes}"></div>
           </div> 
           </div>
           <div class="col-md-3"></div>
           </div>
