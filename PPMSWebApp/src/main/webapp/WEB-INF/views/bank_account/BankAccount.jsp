...
<body>
	...
	<div class="row">
		...
		<div class="row">
			...
			<div style="margin-top:20px;"><h4>Create Bank Account</h4></div><hr>
		
		<div class="col-md-6">
           <div class="form-group">
             <div class="col-md-4 inp-field">Bank Name</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="bankName" placeholder="Enter Bank name"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Account Name</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="accountName" placeholder="Enter account name"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">A/C Holder's Name</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="accHolderName" placeholder="Enter A/C holder's name"></div>
           </div>
           <div class="col-md-12"></div>
           <div class="form-group">
             <div class="col-md-4 inp-field">A/C Number</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="accNumber" placeholder="Enter A/C number"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">IFSC Code</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="IfscCode" placeholder="Enter IFSC Code"></div>
           </div>
           <div class="form-group">
             <div class="col-md-4 inp-field">Branch</div>
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="branch" placeholder="Enter Branch"></div>
           </div>
          <div class="form-group">
		...
		<div class="col-md-6">  
           ...
           <div class="form-group display-none">
             ...
             <div class="col-md-8 inp-field"><input type="text" class="form-control" name="city" placeholder="Enter city"></div>
           </div>
           <div class="form-group display-none">
          ...
          <div class="col-md-12"><hr></div>
           <div class="row" >
           	...
           	<div class="col-md-3">
             		<button class="btn" style="background-color:#23133a;color:#fff">Create Bank Account</button>
             	</div>
           </div>
         </form>
         </div>
